    ...
    <div className="grid gap-3 px-6 pb-6 pt-2">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          <Label className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Code</Label>
          <Input
            value={form.code}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          ...
          <Select onValueChange={(value) => handleChange("currency", value)} defaultValue="USD">
